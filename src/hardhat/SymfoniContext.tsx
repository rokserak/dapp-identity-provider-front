...
import { IdentityProvider } from "./typechain/IdentityProvider";
import { IdentityProvider__factory } from "./typechain/factories/IdentityProvider__factory";
...
export const IdentityProviderContext = React.createContext<SymfoniIdentityProvider>(emptyContract);
...
export interface SymfoniIdentityProvider {
    instance?: IdentityProvider;
    factory?: IdentityProvider__factory;
}
...
export const Symfoni: React.FC<SymfoniProps> = ({
    ...
    const [IdentityProvider, setIdentityProvider] = useState<SymfoniIdentityProvider>(emptyContract);
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        const doAsync = async () => {
            ...
            const finishWithContracts = (text: string) => {
                setIdentityProvider(getIdentityProvider(_provider, _signer))
                finish(text)
            }
    ...
    const getIdentityProvider = (_provider: providers.Provider, _signer?: Signer) => {
        ...
        const contract: SymfoniIdentityProvider = {
            instance: instance,
            factory: _signer ? new IdentityProvider__factory(_signer) : undefined,
        }
        return contract
    }
        ;
            ...
            <ProviderContext.Provider value={[provider, setProvider]}>
                <SignerContext.Provider value={[signer, setSigner]}>
                    <CurrentAddressContext.Provider value={[currentAddress, setCurrentAddress]}>
                        <IdentityProviderContext.Provider value={IdentityProvider}>
                            {showLoading && loading ?
